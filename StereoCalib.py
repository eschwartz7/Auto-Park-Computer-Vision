...
def stereoCalibration(imagesL, imagesR, CHECKERBOARD):
    ...
    for image in imagesL:
        ...
        if i == 1:
            sizeL = imgL_gray.shape
            sizeR = imgL_gray.shape
    ...
    rectify_scale = 1
    rect_l, rect_r, proj_l, proj_r, Q, roiL, roiR = cv2.stereoRectify(new_mtxL, distL, new_mtxR, distR,
    ...
    with open('stereocalibdata.json', 'w') as fid:
